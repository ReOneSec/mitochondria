            ...
            return (
              <Reveal key={index} delay={index * 100} className="h-full">
                <div 
                  ...
                  className={`flex flex-col h-full p-8 md:p-10 transition-all duration-500 border rounded-3xl relative group cursor-pointer ${
                  isSelected 
                  ...
                  <div className="mb-10 relative">
                    ...
                    <p className={`text-xs mt-4 uppercase tracking-wider ${isSelected ? 'text-slate-400' : 'text-slate-500'}`}>{plan.period}</p>
                  </div>

                  <div className={`h-px w-full mb-8 ${isSelected ? 'bg-slate-800' : 'bg-slate-100'}`}></div>
                  ...
                  <button className={`w-full py-4 text-xs font-bold uppercase tracking-widest transition-all duration-300 flex items-center justify-center gap-3 rounded-xl group-hover:scale-[1.02] active:scale-[0.98] ${
                     isSelected 
